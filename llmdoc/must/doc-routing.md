...
## Read Next By Task
- For `/llmdoc:init` changes: read `llmdoc/architecture/init-investigation-orchestration.md`, `llmdoc/guides/init-user-calibration.md`, and `llmdoc/guides/updating-init-investigation-depth.md`, especially when changing fan-out thresholds, report persistence fallback, transport-failure recovery, follow-up gates, or exclusion rules.
...
- If the question is about how to execute a recurring maintenance task, prefer `guides/`.
- If the question is about stable filenames, commands, or config surfaces, prefer `reference/`.
